...
<div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
    <h3 class="text-lg font-semibold text-slate-800 mb-2">Welcome to Registrar Portal</h3>
    <p class="text-slate-500">Manage academic structure, student records, teacher information, and enrollment processes.</p>
</div>
