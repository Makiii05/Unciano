            ...
            <nav class="flex-1 overflow-y-auto p-3 space-y-1">
                ...
                $sidebar = match($type) {
                    ...
                    'department' => [
                        ...
                        ['section' => 'Grading', 'items' => [
                            ['label' => 'Grading System', 'url' => '/department/grading-systems/index.php', 'icon' => 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z'],
                            ['label' => 'Grading Components', 'url' => '/department/grading-components/index.php', 'icon' => 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z'],
                        ]],
                    ],
                    'student' => [
                        ['section' => 'General', 'items' => [
