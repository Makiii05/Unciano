<dialog id="delete-modal" class="modal">
    <div class="bg-white rounded-xl shadow-xl max-w-sm w-full">
        <form method="POST" id="delete-form">
            <?= csrf_field() ?>
            <input type="hidden" name="account_id" id="delete-id">
            <input type="hidden" name="user_id" id="delete-user-id">
            <input type="hidden" name="teacher_account_id" id="delete-teacher-id">
            <input type="hidden" name="student_account_id" id="delete-student-id">
            <div class="p-6 text-center">
                ...
                <h3 class="text-lg font-semibold text-slate-800 mb-2">Delete Account</h3>
            ...
            <div class="flex justify-center gap-2 p-6 pt-2">
                <button type="button" onclick="document.getElementById('delete-modal').close()" class="px-4 py-2 text-sm font-medium text-slate-600 hover:bg-slate-100 rounded-lg transition-colors">Cancel</button>
